...
# (see Desmos graph https://www.desmos.com/calculator/3zdtoju18q for example)
LIGHT_ROTATION = 90.0
CAMERA_ROTATION = 80.0
# if LIGHT_ABOVE=1, then light rotation is ignored, ...
# ... and light source is placed directly above the data
LIGHT_ABOVE = 1
